...
ya2=[];
yb3=[];
for i=[0:0.01:0.5,0.501:0.001:0.509,0.51:0.01:1]  

    beta=i;
    
    u0=0.01336;
    u1=u0; u2=u0; d=0.258; lp=0; c=0; f=0.01;
    Rd=0; Rl=0; m=0.00654; k=0.00428107; ld=0.00138;
    lo=0.03;
    Ri=6; li=0.2;%Pawnee site

    tn=18000;x0=[100;100;20;10];
    ...
    Nlos=Ri+(k+m)*ND-(d+lp+c-f)*Pi;%Nlos=Ri+(k+m)*ND-Phi
...
x=[0:0.01:0.5,0.501:0.001:0.509,0.51:0.01:1];
